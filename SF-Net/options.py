...
parser.add_argument('--num-class', type=int, default=21, help='number of classes (default: 20+1)')
parser.add_argument('--dataset-name', default='Thumos14reduced', help='dataset to train on (default: Thumos14)')
...
parser.add_argument('--length', type=int, default=0, help='point+length of the sequence for pointLoss')
